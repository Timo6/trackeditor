...
namespace Vamos_Track
{
  ...
  public:
    ...
    double curvature (double along, double offline_fraction) const;
    double distance (double along) const;
  ...
  private:
    ...
    void propagate (const Road& road,
                    ...
                    double time_step,
                    bool close);
    double force (const Vamos_Geometry::Three_Vector& p1,
    ...
    void load_curvature (double distance,
                         ...
                         const Vamos_Track::Gl_Road_Segment& segment);

    double m_length;
    Vamos_Geometry::Parametric_Spline* mp_line;
    Vamos_Geometry::Spline m_curvature;
    Vamos_Geometry::Spline m_left_curvature;
    Vamos_Geometry::Spline m_right_curvature;
    Vamos_Geometry::Linear_Interpolator m_distance;
	GLuint m_list_id;
    double m_distance_factor;
    double m_stiffness;
  ...
  public:
    ...
    void set_start_slope (double slope);
    void set_start_direction (double degrees)
    { m_start_direction = Vamos_Geometry::deg_to_rad (degrees); }
  ...
  public:
    ...
    static std::vector <double> s_parameters;
    static void set_parameters (const std::vector <double>& parameters) 
